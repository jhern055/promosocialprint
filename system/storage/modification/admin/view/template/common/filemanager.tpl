            ...
            <?php
				...
				$ckeditor = isset($this->request->get['CKEditorFuncNum']) ? $this->request->get['CKEditorFuncNum'] : null;
				$imgpath = HTTP_CATALOG . 'image/';
				$base = $this->request->server['HTTPS'] ? HTTPS_SERVER : HTTP_SERVER;
				$params = http_build_query(array(
					'CKEditor' 			=> isset($this->request->get['CKEditor']) ? $this->request->get['CKEditor'] : null,
					'CKEditorFuncNum' 	=> isset($this->request->get['CKEditorFuncNum']) ? $this->request->get['CKEditor'] : null,
					'langCode'			=> isset($this->request->get['langCode']) ? $this->request->get['langCode'] : null
				));
			?>
            <?php if (!$is_ajax): ?>
            <!DOCTYPE html>
