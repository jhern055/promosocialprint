...
// Help
$_['help_address_format']     = 'Nombre = {firstname}<br />Apellidos = {lastname}<br />Facturar a = {company}<br />Calle = {address_1}<br />Colonia = {address_2}<br />Ciudad = {city}<br />C&oacute;digo Postal = {postcode}<br />Provincia = {zone}<br />C&oacute;digo Provincia = {zone_code}<br />pa&iacute;s = {country}';
